...
const Checkbox = ({ label, checked, onChange }: CheckboxProps) => {
    ...
    return (
        <label className="relative inline-flex items-center cursor-pointer">
            ...
            peer peer-focus:ring-2 peer-focus:ring-primary-800 peer-checked:after:translate-x-full peer-checked:after:border-white 
            after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border 
            after:rounded-full after:h-5 after:w-5 after:transition-all border-gray-600 peer-checked:bg-primary-600"></div>
